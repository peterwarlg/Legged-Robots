...
class RobotStatus:
    def __init__(self):
        ...
        # 事实上AB腿的计算矩阵是一样的，都是机身相对于固连世界坐标系的矩阵
        # A腿计算矩阵
        ...
        # A r x z
        self.joint_space_lxz_LegA = JointSpaceLXZ(0.8, 0.0, 0.0, 0.0)
        self.joint_space_lxz_dot_LegA = JointSpaceLXZ(0.0, 0.0, 0.0, 0.0)
        # B r x z
        self.joint_space_lxz_LegB = JointSpaceLXZ(0.8, 0.0, 0.0, 0.0)
        self.joint_space_lxz_dot_LegB = JointSpaceLXZ(0.0, 0.0, 0.0, 0.0)
